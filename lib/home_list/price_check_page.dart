...
class _PriceCheckPageState extends State<PriceCheckPage> {
  ...
  getPrice({barcode}) async {
    ...
    print( "Store : ${activatedStore} ...${companyCode}");
    var bdy = {
      "dataAreaId": companyCode,
      "storeCode": activatedStore// 1 - to get only counting journal lines
    };
    print(bdy);
    var body = {
      "transType": 8,
    ...
    if (res.statusCode == 200 || res.statusCode == 201) {
      ...
      descriptionController.text =
          responseJson[0]['Importdata'][0]['ItemName'];

      sizeController.text = responseJson[0]['Importdata'][0]['SIZEID'];
      uomController.text = responseJson[0]['Importdata'][0]['UNIT'];

      colorController.text = responseJson[0]['Importdata'][0]['COLORID'];
      styleController.text = responseJson[0]['Importdata'][0]['STYLEID'];

      configController.text = responseJson[0]['Importdata'][0]['CONFIGID'];
      activePriceController.text =  "Active Price : ${responseJson[0]['Importdata'][0]['ItemAmount'].toString()}";
      // """Active Price :"
      //     "${responseJson[0]['Importdata'][0]['ItemAmount'].toString()}""";
  ...
  getItemAmount() {
    ...
    activePriceController.text = "Active Price :${ widget.itemDetails['ItemAmount'].toString()}";
  ...
  void initState() {
    ...
    print(widget.itemDetails);
    print("init itemMasters");
    print(widget.isItemMasters);
                  ...
                  decoration: InputDecoration(
                      ...
                      suffixIcon: IconButton(
                        ...
                        onPressed: () async {
                          ...
                          //   showDialogGotData("Cannot add item,Document Status is'Closed'");
                          //   return;
                          // }
                          // // return;
                          //
                          ...
                          //                   isContinousScan: disabledContinuosScan == "true" ? true:false,
